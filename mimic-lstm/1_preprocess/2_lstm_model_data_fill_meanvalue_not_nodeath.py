...
def get_subject_charts(time_period):
    ...
    result_csv = TO_ROOT+'lstm_model_data_fill_meanvalue_tabel_normal_nodeath.csv'
...
def get_final_chart_value(chart_name_list, time_period):
    result_value = second_fill_0_nodeath(chart_name_list, time_period)
    try:
...
def second_fill_0_nodeath(chart_name_list, time_period):
