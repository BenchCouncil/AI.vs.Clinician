...
def first_not():
    ...
    df_not_first['hadmid_sample'] = df_not_first['hadm_id'].astype(str) + 'fist'
...
def train_val_test(df_ill_0h,df_ill_3h_back,df_not,df_not_add,df_not_add_12h):
    df = pd.concat([df_ill_0h,df_ill_3h_back,df_not,df_not_add,df_not_add_12h])
    ...
    process_model_input(df_train_input, ROOT + f'{kind}_del_missdata_{miss_rate}/lstm_0h_train_model_input_data_by_{kind}_del_missdata_{miss_rate}.csv')
    process_model_input(df_val_input, ROOT + f'{kind}_del_missdata_{miss_rate}/lstm_0h_val_model_input_data_by_{kind}_del_missdata_{miss_rate}.csv')
    process_model_input(df_test_input, ROOT + f'{kind}_del_missdata_{miss_rate}/lstm_0h_test_model_input_data_by_{kind}_del_missdata_{miss_rate}.csv')
...
if __name__ == '__main__':
    ...
    train_val_test(time_period_0h_label(),time_period_3h_back_label(),first_not(),add_not(),add_not_12h())
    print('end')
