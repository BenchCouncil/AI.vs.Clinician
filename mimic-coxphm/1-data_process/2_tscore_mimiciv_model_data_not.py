...
result_csv = TO_ROOT + 'tscore_mimiciv_not_model_input_data_by_diff_meanvalue.csv'
...
def process_not_row(args):
    ...
    while i < 50:
        ...
        get_subject_charts(subject_id, hadm_id, df_chart_current_period, df_subject_diagnose_set, flag, df_12h, df_2h,
                           gender, start_time, end_time, admit_time,ill_time, hour_to_admintime,death_time,ill_label,period_end_to_illtime)
...
def get_subject_charts(subject_id, hadm_id, df_chart_current_period, df_subject_diagnose_set, ae_flag, df_12h, df_2h,
                       gender, start_time, end_time, admit_time,ill_time,hour_to_admittime,death_time,ill_label,hour_to_illtime):
    # 在当前检查项的时间段中筛选每列的值
